    ...
    public function create() {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            if (isset($_POST['nombre'])) {
                ...
                if ($this->sexo->create()) {
                    header('Location: /meta6b/sexo/index');
                    exit;
                } else {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            if (isset($_POST['id'])) {
                ...
                if ($this->sexo->delete()) {
                    ...
                    header('Location: /meta6b/sexo/index?msg=error');
                    exit;
                }
            } else {
                echo "No se especificó el ID";
            }
        } else {
            echo "Método incorrecto";
        }
...
if (isset($_GET['action'])) {
    ...
    // Si no se especifica ninguna acción, redirigir a la lista de sexos
    header('Location: /meta6b/sexo/index');
    exit;
}
?>
